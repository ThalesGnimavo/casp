...
> `casp/private-docs/fable-brief-casp-roadmap-proposal.md` (authored outside the
...
> verdict logic untouched) and write `docs/ROADMAP-PROPOSAL.md` — every backlog
...
**Project root.** `/Users/juste/ZeroSuite/cockpit-skill`
...
4. **`docs/ROADMAP-PROPOSAL.md`** — tiers, protocol/tooling tags, cuts with arguments, restraint section, hygiene flags.
